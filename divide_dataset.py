...
# classes = ["FK_OK"]
classes = ['fakou', 'fanjiao']

TRAIN_RATIO = 90
wd = r'F:\HuoChe\yolov5_model\SevenModel'
...
def convert_annotation(image_id):
    in_file = open(wd + '\\' + 'Annotations/%s.xml' % image_id, encoding='gb18030', errors='ignore')
    out_file = open(wd + '\\' + 'images/%s.txt' % image_id, 'w', encoding='gb18030',
                    errors='ignore')
